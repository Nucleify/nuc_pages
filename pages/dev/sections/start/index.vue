  ...
  <section id="dev-start" class="dev-start">
    ...
    <div class="container dev-start-inner">
      <div class="dev-start-left">
        <h1 class="dev-start-heading">{{ $t('dev-header') }}</h1>

        <p class="dev-start-description">{{ $t('dev-description') }}</p>
        ...
        <div class="dev-start-features">
          ...
          >
            <div class="dev-feature-icon"><Icon :name="feature.icon" /></div>
      ...
      <div class="dev-start-right">
        <div class="dev-terminal">
          <div class="dev-terminal-header">
            <div class="dev-terminal-dots"><span /><span /><span /></div>
          ...
          <div class="dev-terminal-body">
            <div class="dev-terminal-line">
              ...
              <span class="dev-terminal-cmd">make nuxt</span>
            </div>
            ...
            <div
              class="dev-terminal-line dev-terminal-output dev-terminal-success"
            >
...
import { demoLogin, navigateToUrl, flashToast } from 'nucleify'
