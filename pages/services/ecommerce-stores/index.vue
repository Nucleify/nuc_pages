  ...
  <div class="service-container">
    <section class="service-hero">
      ...
      <div class="service-hero-content container">
        ...
        <p class="service-hero-subtitle">{{ $t('service-ec-subtitle') }}</p>
      ...
      <div class="container">
        ...
        <div class="service-dashboard-preview">
          <div class="service-dashboard-header">
            <div class="service-dashboard-dots"><span /><span /><span /></div>
            <span class="service-dashboard-title">
          ...
          <div class="service-dashboard-body">
            <div class="service-dashboard-stats">
              <div
                ...
                :key="stat.label"
                class="service-dashboard-stat"
              >
                <div class="service-dashboard-stat-icon">
                  <Icon :name="stat.icon" />
                </div>
                <span class="service-dashboard-stat-value">
                  {{ stat.value }}
                </span>
                <span class="service-dashboard-stat-label">
                  {{ stat.label }}
                </span>
                <span
                  class="service-dashboard-stat-change"
                  :class="{ positive: stat.positive }"
                >
                  <Icon
                    :name="stat.positive ? 'mdi:trending-up' : 'mdi:trending-down'"
                  />
                  {{ stat.change }}
                </span>
              </div>
            ...
            <div class="service-dashboard-chart">
              <div class="service-dashboard-chart-label">
      ...
      <div class="container">
        ...
        <div class="service-integrations-grid">
          <div
            ...
            class="service-integration-card"
          >
